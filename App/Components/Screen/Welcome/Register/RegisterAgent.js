...
class RegisterAgent extends Component {
  ...
  render() {
    return (
      <View style={{flex: 1}}>
        <ImageBackground
          source={require('./../../../../assets/image/bg_login_register.png')}
          style={{
            flex: 1,
            resizeMode: 'cover',
          }}>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <View style={styles.textContent}>
                  <Text style={{color: '#f65c06'}}>Lupa kata sandi ? </Text>
                </View>
              </TouchableOpacity>
              ...
              <View style={styles.containerText}>
                <View style={styles.textContent2}>
                  ...
                  <TouchableOpacity onPress={() => this.gotoRegister()}>
                    <Text style={{color: '#0a61c3'}}>Daftar disini</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
...
export default withNavigation(RegisterAgent);
