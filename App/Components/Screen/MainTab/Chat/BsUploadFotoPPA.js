...
class BsUploadFotoPPA extends Component {
  constructor(props) {
    super(props);
    dataUser();
    this.state = {
  ...
  componentDidMount() {
    this.props.onUploadFotoPPA(this);
    this.getLocation();
  ...
  componentWillUnmount() {
    this.props.onUploadFotoPPA(undefined);
  }
  componentDidUpdate() {}
  ...
  setModalVisible(value, title) {
    this.RBSheet.open();
    if (title == "Asuransi kecelakaan diri syariah") {
    ...
    if (this.state.errorHit == false) {
      ...
      await postDataWitHeader(
        Api.base_url2 +
          "tripa/" +
          id +
          "/upload_foto_pengajuan_personalaccident",
        param,
        tok
      )
        .then((res) => {
        ...
        >
          <View style={styles.contentbottomSheet}>
            ...
            >
              ...
              >
                {this.state.title == ""
                  ? "Form Upload Foto Asuransi Kecelakaan Diri"
                  : "Form Upload Foto  Asuransi Kecelakaan Diri Syariah"}
              </Text>
            </View>
            <ScrollView>
              <View
...
export default BsUploadFotoPPA;
