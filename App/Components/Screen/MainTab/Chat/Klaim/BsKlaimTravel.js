...
class BsKlaimTravel extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    this.props.onKlaimTravel(this);
  }
  componentWillUnmount() {
    this.props.onKlaimTravel(undefined);
  }
  ...
  async nextForm() {
    ...
    if (this.state.isAlertForm == true) {
      var dataForm = {
        ...
        estimasi_kerugian: this.state.estimasiKerugian.replace(
          /,.*|[^0-9]/g,
          '',
        ),
      };
  ...
  onLossValue(value) {
    ...
    this.setState({estimasiKerugian: convertToRupiah(value)});
  }
  ...
  validationsForm() {
    if (
      ...
      this.state.estimasiKerugian == '' ||
      this.state.estimasiKerugian == '- Pilih -' ||
      this.state.estimasiKerugian == null
    ) {
      this.setState({isAlertForm: false});
        ...
        <View style={styles.contentbottomSheet}>
          <View
            ...
            <Text
              ...
              Form Pengajuan Klaim Asuransi Travel{' '}
            </Text>
          </View>
          <ScrollView>
            <View
              ...
              <TextInput
                ...
                value={this.state.estimasiKerugian}
                keyboardType={'numeric'}
                onChangeText={estimasiKerugian =>
                  this.onLossValue(estimasiKerugian)
                }
              />
