...
class BsKlaimKendaraan extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    this.props.onKlaimKendaraan(this);
  }
  componentWillUnmount() {
    this.props.onKlaimKendaraan(undefined);
  }
  ...
  async nextForm() {
    ...
    if (this.state.isAlertForm == true) {
      var dataForm = {
        ...
        no_polisi_kendaraan: this.state.noPolisiKendaraan,
        ...
        kerusakan: this.state.bagiankendaraan,
  ...
  async validationsForm() {
    if (
      ...
      this.state.bagiankendaraan == '' ||
      this.state.bagiankendaraan == null
    ) {
      this.setState({isAlertForm: false});
      this.customAlert(
        'Perhatian',
        'Harap isi Bagian Kendaraan Yang Mengalami Kerusakan',
      );
    } else if (
        ...
        <View style={styles.contentbottomSheet}>
          <View
            ...
            <Text
              ...
              Form Pengajuan Klaim Asuransi Kendaraan{' '}
            </Text>
          </View>
          <ScrollView>
            <View
              ...
              <TextInput
                ...
                multiline={true}
                style={styles.inputs}
                placeholder="Bagian Kendaraan Yang Mengalami Kerusakan"
                value={this.state.bagiankendaraan}
                onChangeText={bagiankendaraan =>
                  this.setState({bagiankendaraan})
                }
              />
...
export default BsKlaimKendaraan;
