...
class BsUploadFotoTravel extends Component {
  constructor(props) {
    super(props);
    dataUser();
    this.state = {
  ...
  componentDidMount() {
    this.props.onUploadFotoTravel(this);
    this.getLocation();
  ...
  componentWillUnmount() {
    this.props.onUploadFotoTravel(undefined);
  }
  componentDidUpdate() {}
  ...
  //         // this.setState({
  //         //   dataFileKTPTertanggung: source.data,
  //         //   nameFileKTPTertanggung: source.fileName,
  //         // });
  //         // this.simpanProfile();
  //         this.state.dataUpload[index].data = response.data;
  //         this.setState({isPhoto: false});
  //         this.RBSheet.open();
  //         console.log('Open');
  //       }
  ...
  async postFoto() {
    ...
    if (this.state.errorHit == false) {
      ...
      console.log('postFoto', this.state.latitude + ' ' + this.state.longitude);
      var param = {
      ...
      await postDataWitHeader(
        Api.base_url2 + 'tripa/' + id + '/upload_foto_pengajuan_travel',
        param,
        tok,
      )
        .then(res => {
          if (res.success != false) {
            console.log('postFoto =', this.state.latitude);
...
export default BsUploadFotoTravel;
