...
class BsUploadFotoKendaraan extends Component {
  constructor(props) {
    super(props);
    dataUser();
    this.state = {
      ...
      dataUpload: [
        ...
        {
          id: 2,
          title: " Foto dari sudut kiri depan kendaraan\n",
          name: "",
          data: "",
          path: require("./../../../../assets/image/no_image.png"),
          uri: "",
        ...
        {
          id: 3,
          title: " Foto dari sudut kanan belakang kendaraan \n",
          name: "",
          data: "",
          path: require("./../../../../assets/image/no_image.png"),
          uri: "",
        ...
        {
          id: 4,
          title: " Foto selfie dengan kendaraan\n",
          name: "",
          data: "",
          path: require("./../../../../assets/image/no_image.png"),
          uri: "",
        ...
        {
          id: 5,
          title: " Foto peralatan non standart\n",
          name: "",
          data: "",
          path: require("./../../../../assets/image/no_image.png"),
          uri: "",
  ...
  componentDidMount() {
    this.props.onUploadFotoKendaraan(this);
    this.getLocation();
  ...
  componentWillUnmount() {
    this.props.onUploadFotoKendaraan(undefined);
  }
  componentDidUpdate() {}
  ...
  setModalVisible(value, title) {
    ...
    console.log("render bottom shet upload", this.state.id_polis);
  }
  batal() {
  ...
  async postFoto() {
    ...
    if (this.state.errorHit == false) {
      ...
      var param = {
        ...
        foto_front_left: this.state.dataUpload[2].data,
        foto_back_right: this.state.dataUpload[3].data,
        foto_dashboard_vehicle: this.state.dataUpload[4].data,
        foto_non_standard_vehicle: this.state.dataUpload[5].data,
      ...
      await postDataWitHeader(
        Api.base_url2 + "tripa/" + id + "/upload_foto_pengajuan_kendaraan",
        param,
        tok
      )
        .then((res) => {
        ...
        >
          <View style={styles.contentbottomSheet}>
            ...
            >
              ...
              >
                {this.state.title == ""
                  ? "Form Upload Foto Polis Kendaraan"
                  : "Form Upload Foto Polis Kendaraan Syariah"}
              </Text>
            </View>
            <ScrollView>
              <View
...
export default BsUploadFotoKendaraan;
